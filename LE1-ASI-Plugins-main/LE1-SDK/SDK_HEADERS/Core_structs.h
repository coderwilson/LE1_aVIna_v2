...
struct FBioStrRes
{
	struct FString                                     sText;                                            		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     sSoundRef;                                        		// 0x0010 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
	struct FString                                     sLipsyncRef;                                      		// 0x0020 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
...
struct FPointer
{
	void*                                              Ptr;                                            		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
};
...
// ScriptStruct Core.Object.LevelBitArray_Mirror
// 0x0030
struct FLevelBitArray_Mirror
{
	struct FPointer                                    IndirectData;                                     		// 0x0000 (0x0008) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                InlineData[ 0x8 ];                                		// 0x0008 (0x0020) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                NumBits;                                          		// 0x0028 (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
	int                                                MaxBits;                                          		// 0x002C (0x0004) [0x0000000000001002]              ( CPF_Const | CPF_Native )
};
...
struct FBioDlgToken
{
	struct FString                                     sToken;                                           		// 0x0000 (0x0010) [0x0000000000400000]              ( CPF_NeedCtorLink )
